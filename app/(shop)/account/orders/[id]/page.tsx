...
export default async function OrderDetailPage({
   ...
   *
   * customer_id sengaja digunakan sebagai filter
   * tambahan agar user tidak dapat membuka order
   * milik customer lain melalui URL.
   */
  const {
    data: order,
    error: orderError,
            ...
            {orderItemsError ? (
              <div className="mt-5 rounded-xl border border-red-200 bg-red-50 p-4">
                <p className="text-sm text-red-700">
                  Gagal mengambil detail produk pesanan.
                </p>
              </div>
            ) : items.length === 0 ? (
